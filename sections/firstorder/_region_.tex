\message{ !name(semanticTableauxFirstOrderLogic.tex)}
\message{ !name(semanticTableauxFirstOrderLogic.tex) !offset(-2) }
...
\end{document} 
\message{ !name(semanticTableauxFirstOrderLogic.tex) !offset(-87) }
